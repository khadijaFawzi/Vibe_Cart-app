// lib/screens/category_in_center_screen.dart
  ...
  Future<void> _loadProducts() async {
    ...
    try {
      final products = await context
          ...
          .getCenterCategoryProducts(widget.center.id, widget.category.id);
                      ...
                      child: ElevatedButton(
                        onPressed: isInCart
                            ...
                            : () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar( // lib/screens/category_in_center_screen.dart (تكملة)
                                  const SnackBar(
