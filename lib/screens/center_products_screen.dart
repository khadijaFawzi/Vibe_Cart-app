...
//   }
// }
// lib/screens/supermarket_products_screen.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
...
class _SupermarketProductsScreenState extends State<SupermarketProductsScreen> {
  ...
  Future<void> _loadProducts() async {
    ...
    try {
      ...
      products = await productsProvider.getProductsBySupermarket(widget.supermarket.id);
    } catch (e) {
      error = 'حدث خطأ: $e';
    } finally {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.supermarket.supermarketName),
          centerTitle: true,
        ),
        body: isLoading 
            ? Center(
